...
public class MyPatientAdapter extends RecyclerView.Adapter<MyPatientAdapter.ViewHolder> {
        ...
        public MyPatientAdapter(Context context, ArrayList<ModelForMyPrescription> modelForMyPrescriptionArrayList) {
        ...
        @NonNull
        @Override
        public MyPatientAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view = LayoutInflater.from(context).inflate(R.layout.my_prescription_rv, parent, false);
            return new MyPatientAdapter.ViewHolder(view);
        }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.patientName.setText(modal.getPatName());
        ...
        public static class ViewHolder extends RecyclerView.ViewHolder{
            ...
            TextView patientName, appointmentDate, prescription;

            public ViewHolder(@NonNull View itemView) {
                super(itemView);

                patientName = itemView.findViewById(R.id.doctorName_my_presc);
